...
public class Prefix {
	...
	public static void main(String[] args) {
		...
		ParallelPrefixExec pe2 = new ParallelPrefixExec(length, 4);
		long[] times3 = new long[max];
		for (int i = 0; i < max; i++) {
			pe2.resetArray();
			start = System.nanoTime();
			pe2.parallelPrefix(200);
			end = System.nanoTime();
			long exTime = end - start;
			times3[i] = exTime;
		}
		pe2.shutdown();
		Arrays.sort(times3);
		System.out.println("Executor-Median, 200 Threads: " + times3[0]);
//
